...
_cgi_ext(""), _cgi_bin(""), _language(""), _auto_index(""), _auth_basic("") , _auth_basic_file(""), _body_size(-1), _location_path(""){}
...
_cgi_bin(other._cgi_bin), _language(other._language), _auto_index(other._auto_index),
